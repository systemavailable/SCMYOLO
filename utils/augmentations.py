...
class Albumentations:
    ...
    def __init__(self, size=640):
        ...
        try:
            ...
            T = [
                A.RandomResizedCrop(height=size, width=size, scale=(0.8, 1.0), ratio=(0.9, 1.11), p=0.15),
                A.Blur(p=0.15),  # 随机模糊
                ...
                A.RandomGamma(p=0.0),
                A.ImageCompression(quality_lower=75, p=0.01)]  # transforms,减少图像的 Jpeg、WebP 压缩
